        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-8 space-y-6">
            ...
            {isSignUp && (
              <div>
                ...
                <input
                  ...
                  className="appearance-none rounded-lg relative block w-full px-3 py-2 bg-white/20 border border-gray-300 placeholder-gray-400 text-white focus:outline-none focus:ring-green-500 focus:border-green-500"
          ...
          <div>
            <button
              ...
              disabled={loading}
              className="w-full flex justify-center items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-300 bg-white/10 hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50"
            >
